            ...
            <Top>
              <Row>
                <Flex>
                  ...
                  {job.salary && (
                    <PriceChip min={job.salary.min} max={job.salary.max} />
                  )}
                </Flex>
                <DurationWidget
                  type={"Posted Date"}
                  date={calculateTimeDifference(job.createdAt)}
                />
              </Row>
            </Top>
            <Flex>
            ...
            <Row>
              ...
              >
                ...
                <Specifications>
                  <ul>
                    <li>{job.site}</li>
                    <li>{job.fullTime || "Part-time"}</li>
                    <li>{job.companyName || "Freelance"}</li>
                  </ul>
                </Specifications>
              </div>
              <span
